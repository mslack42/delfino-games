...
export function GameHolderList(props: GameHolderListProps) {
  ...
  return (
    <>
      <h2 className="w-full text-2xl text-center">Office</h2>
          ...
          return (
            <AccordionItem value={v} key={i}>
              <AccordionTrigger
                ...
                className={twJoin(
                  "rounded-lg text-center flex justify-center my-1 text-white w-full text-2xl",
                  isOpen ? "bg-teal-500" : "bg-slate-600"
                )}
              >
                {v}
              </AccordionTrigger>
